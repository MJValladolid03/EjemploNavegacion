...
class PrimeroFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        btnF2.setOnClickListener {
            findNavController().navigate(R.id.action_primeroFragment2_to_segundoFragment2) }
        btnF3.setOnClickListener {
            findNavController().navigate(R.id.action_primeroFragment2_to_terceroFragment2) }
        return aux
    }
